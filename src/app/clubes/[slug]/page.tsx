      ...
      <div className="mx-auto max-w-6xl px-4 py-8 grid md:grid-cols-3 gap-6">
        ...
        <div>
          <Card className="p-4">
            ...
            <div className="mt-3 text-xs leading-relaxed text-zinc-600">{work ? `Tiragem limitada de ${work.maxSupply.toLocaleString("pt-BR")} exemplares • Numeração atribuída após a confirmação` : "Em breve"}</div>
          </Card>
        </div>
      </div>
    </div>
