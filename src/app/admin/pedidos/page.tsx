  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="mt-4 space-y-3">
        {orders.length === 0 && <div className="text-sm text-zinc-500">Nenhum pedido pendente.</div>}
        {orders.map((order) => (
          <Card key={order.id} className="p-4">
            <div className="flex justify-between items-start gap-3">
              <div>
                ...
                <div className="text-xs text-zinc-500">{order.items.map((i) => i.work.title).join(", ")}</div>
