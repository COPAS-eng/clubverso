...
const FAQS = [
  {
    ...
    a: "Você recebe a HQ digital de 25 páginas em PDF personalizado com o número da sua edição, selo de autenticidade em cada página, além do certificado de autenticidade com QR Code individual para verificação.",
  },
  {
